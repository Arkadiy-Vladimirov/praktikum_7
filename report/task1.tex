\section{Задание 1}
    ...
    \subsection{Игра в орлянку}
        ...
        Оценим $Y(n)$ при $n \rightarrow \infty$:
        
        \[\lim_{n \rightarrow \infty}\Exp{Y(n)} = 
          \lim_{n \rightarrow \infty}\Exp{\frac{S_i}{\sqrt{n}}} = 
          \lim_{n \rightarrow \infty}\Exp{\frac{\sum_{j = 1}^{n} \theta_j}{\sqrt{n}}} =
          \lim_{n \rightarrow \infty}\frac{1}{\sqrt{n}}\sum_{j = 1}^{n} \Exp{\theta_j} =
          \lim_{n \rightarrow \infty}\frac{1}{\sqrt{n}}\cdot 0 = 
          0.
        \]
